...
async function getLogs(client, { address, blockHash, fromBlock, toBlock, event, args, } = {}) {
    let topics = [];
    if (event)
        topics = (0, index_js_1.encodeEventTopics)({
            abi: [event],
            ...
            params: [
                {
                    address,
                    topics,
                    fromBlock: typeof fromBlock === 'bigint' ? (0, index_js_1.numberToHex)(fromBlock) : fromBlock,
                    toBlock: typeof toBlock === 'bigint' ? (0, index_js_1.numberToHex)(toBlock) : toBlock,
                },
            ],
        });
    }
