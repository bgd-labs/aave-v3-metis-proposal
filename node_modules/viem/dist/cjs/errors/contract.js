...
class CallExecutionError extends base_js_1.BaseError {
    constructor(cause, { account: account_, docsPath, chain, data, gas, gasPrice, maxFeePerGas, maxPriorityFeePerGas, nonce, to, value, }) {
        const account = account_ ? (0, index_js_2.parseAccount)(account_) : undefined;
        const prettyArgs = (0, transaction_js_1.prettyPrint)({
            from: account?.address,
            to,
            value: typeof value !== 'undefined' &&
                `${(0, index_js_2.formatEther)(value)} ${chain?.nativeCurrency.symbol || 'ETH'}`,
            data,
            gas,
            gasPrice: typeof gasPrice !== 'undefined' && `${(0, index_js_2.formatGwei)(gasPrice)} gwei`,
            maxFeePerGas: typeof maxFeePerGas !== 'undefined' &&
                `${(0, index_js_2.formatGwei)(maxFeePerGas)} gwei`,
            maxPriorityFeePerGas: typeof maxPriorityFeePerGas !== 'undefined' &&
                `${(0, index_js_2.formatGwei)(maxPriorityFeePerGas)} gwei`,
            nonce,
        });
...
class ContractFunctionExecutionError extends base_js_1.BaseError {
    constructor(cause, { abi, args, contractAddress, docsPath, functionName, sender, }) {
        const abiItem = (0, index_js_2.getAbiItem)({ abi, args, name: functionName });
        const formattedArgs = abiItem
            ? (0, index_js_2.formatAbiItemWithArgs)({
                abiItem,
                args,
        ...
        const functionWithParams = abiItem
            ? (0, index_js_2.formatAbiItem)(abiItem, { includeName: true })
            : undefined;
        const prettyArgs = (0, transaction_js_1.prettyPrint)({
...
class ContractFunctionRevertedError extends base_js_1.BaseError {
    constructor({ abi, data, functionName, message, }) {
        ...
        let reason;
        if (data && data !== '0x') {
            decodedData = (0, index_js_2.decodeErrorResult)({ abi, data });
            ...
            if (errorName === 'Error') {
                ...
                reason = index_js_1.panicReasons[firstArg];
            }
            else if (errorArgs) {
