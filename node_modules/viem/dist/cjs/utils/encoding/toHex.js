...
function boolToHex(value, opts = {}) {
    ...
    if (typeof opts.size === 'number') {
        ...
        return (0, index_js_1.pad)(hex, { size: opts.size });
    }
    return hex;
}
...
function bytesToHex(value, opts = {}) {
    ...
    if (typeof opts.size === 'number') {
        (0, fromHex_js_1.assertSize)(hex, { size: opts.size });
        return (0, index_js_1.pad)(hex, { dir: 'right', size: opts.size });
    }
    return hex;
}
...
function numberToHex(value_, opts = {}) {
    ...
    if ((maxValue && value > maxValue) || value < minValue) {
        ...
        throw new index_js_2.IntegerOutOfRangeError({
    ...
    const hex = `0x${(signed && value < 0
        ...
        : value).toString(16)}`;
    if (size)
        return (0, index_js_1.pad)(hex, { size });
    return hex;
}
