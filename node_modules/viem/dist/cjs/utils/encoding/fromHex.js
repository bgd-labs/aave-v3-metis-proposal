...
function assertSize(hexOrBytes, { size }) {
    if ((0, size_js_1.size)(hexOrBytes) > size)
        throw new index_js_1.SizeOverflowError({
...
function hexToBool(hex_, opts = {}) {
    ...
    if (opts.size) {
        assertSize(hex, { size: opts.size });
        hex = (0, index_js_2.trim)(hex);
    }
    if ((0, index_js_2.trim)(hex) === '0x0')
        return false;
    if ((0, index_js_2.trim)(hex) === '0x1')
        return true;
    throw new index_js_1.InvalidHexBooleanError(hex);
}
...
function hexToString(hex, opts = {}) {
    ...
    if (opts.size) {
        ...
        bytes = (0, index_js_2.trim)(bytes, { dir: 'right' });
    }
