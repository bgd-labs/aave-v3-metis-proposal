...
export declare const celo: {
    formatters: {
        ...
        transactionReceipt: (data: Partial<import("./types/rpc.js").RpcTransactionReceipt> & {
            [key: string]: unknown;
        }) => import("./types/transaction.js").TransactionReceipt & {
            feeCurrency: `0x${string}` | null;
            gatewayFee: bigint | null;
            gatewayFeeRecipient: `0x${string}` | null;
        } & {};
        transactionRequest: (data: Partial<import("./types/transaction.js").TransactionRequest> & {
            [key: string]: unknown;
