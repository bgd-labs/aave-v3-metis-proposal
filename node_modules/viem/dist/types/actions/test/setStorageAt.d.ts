 ...
 * })
 */
export declare function setStorageAt<TChain extends Chain | undefined>(client: TestClient<TestClientMode, Transport, TChain>, { address, index, value }: SetStorageAtParameters): Promise<void>;
