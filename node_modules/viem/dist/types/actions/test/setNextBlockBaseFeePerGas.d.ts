 ...
 * })
 */
export declare function setNextBlockBaseFeePerGas<TChain extends Chain | undefined>(client: TestClient<TestClientMode, Transport, TChain>, { baseFeePerGas }: SetNextBlockBaseFeePerGasParameters): Promise<void>;
