 ...
 * })
 */
export declare function setNonce<TChain extends Chain | undefined>(client: TestClient<TestClientMode, Transport, TChain>, { address, nonce }: SetNonceParameters): Promise<void>;
