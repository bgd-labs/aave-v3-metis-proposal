...
async function fetchRateStrategyImage(rate, filePath) {
  const realPath = path.join(process.cwd(), `${filePath}.svg`);
  ...
  const fileStream = fs.createWriteStream(path.join(process.cwd(), realPath));
  if (!body)
 ...
 */
//# sourceMappingURL=chunk-WHISJW2Z.js.map