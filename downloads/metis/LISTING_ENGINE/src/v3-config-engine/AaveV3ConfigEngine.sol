...
contract AaveV3ConfigEngine is IAaveV3ConfigEngine {
    ...
    constructor(
        ...
        require(
            address(rateStrategiesFactory) != address(0),
            "ONLY_NONZERO_RATES_FACTORY"
        );
    ...
    function listAssets(
        ...
        ListingWithCustomImpl[]
            memory customListings = new ListingWithCustomImpl[](
                listings.length
            );
    ...
    function _initAssets(
        ...
        address[] memory strategies = RATE_STRATEGIES_FACTORY.createStrategies(
            rates
        );
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            if (borrows[i].enabledToBorrow != EngineFlags.KEEP_CURRENT) {
                ...
                (, , bool borrowingEnabled, , ) = POOL
                    .getConfiguration(ids[i])
                    .getFlags();
                borrows[i].enabledToBorrow = EngineFlags.fromBool(
                    borrowingEnabled
                );
            }
            ...
            if (borrows[i].enabledToBorrow == EngineFlags.ENABLED) {
                if (
                    borrows[i].stableRateModeEnabled != EngineFlags.KEEP_CURRENT
                ) {
    ...
    function _configRateStrategies(
        ...
        for (uint256 i = 0; i < strategiesParams.length; i++) {
            if (
                strategiesParams[i].variableRateSlope1 ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].variableRateSlope2 ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].optimalUsageRatio ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].baseVariableBorrowRate ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].stableRateSlope1 ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].stableRateSlope2 ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].baseStableRateOffset ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].stableRateExcessOffset ==
                EngineFlags.KEEP_CURRENT ||
                strategiesParams[i].optimalStableToTotalDebtRatio ==
                EngineFlags.KEEP_CURRENT
            ) {
                IV3RateStrategyFactory.RateStrategyParams
                    memory currentStrategyData = RATE_STRATEGIES_FACTORY
                ...
                if (
                    ...
                    strategiesParams[i].variableRateSlope1 = currentStrategyData
                        .variableRateSlope1;
                }
                ...
                if (
                    ...
                    strategiesParams[i].variableRateSlope2 = currentStrategyData
                        .variableRateSlope2;
                }
                ...
                if (
                    ...
                    strategiesParams[i].optimalUsageRatio = currentStrategyData
                        .optimalUsageRatio;
                }
                ...
                if (
                    ...
                    strategiesParams[i]
                        .baseVariableBorrowRate = currentStrategyData
                ...
                if (
                    ...
                    strategiesParams[i].stableRateSlope1 = currentStrategyData
                        .stableRateSlope1;
                }
                ...
                if (
                    ...
                    strategiesParams[i].stableRateSlope2 = currentStrategyData
                        .stableRateSlope2;
                }
                ...
                if (
                    ...
                    strategiesParams[i]
                        .baseStableRateOffset = currentStrategyData
                ...
                if (
                    ...
                    strategiesParams[i]
                        .stableRateExcessOffset = currentStrategyData
                ...
                if (
                    ...
                    strategiesParams[i]
                        .optimalStableToTotalDebtRatio = currentStrategyData
            ...
            if (collaterals[i].liqThreshold != 0) {
                if (
                    ...
                    DataTypes.ReserveConfigurationMap
                        memory configuration = POOL.getConfiguration(ids[i]);
                    (
                        uint256 currentLtv,
                ...
                if (collaterals[i].debtCeiling != EngineFlags.KEEP_CURRENT) {
                    ...
                    POOL_CONFIGURATOR.setDebtCeiling(
                        ids[i],
                        collaterals[i].debtCeiling * 100
                    );
                }
            }

            if (collaterals[i].eModeCategory != EngineFlags.KEEP_CURRENT) {
                POOL_CONFIGURATOR.setAssetEModeCategory(
                    ids[i],
                    safeToUint8(collaterals[i].eModeCategory)
                );
            }
        }
    }
    ...
    function _repackListing(
        ...
        IV3RateStrategyFactory.RateStrategyParams[]
            memory rates = new IV3RateStrategyFactory.RateStrategyParams[](
                listings.length
            );
    ...
    function _repackCapsUpdate(
        ...
        for (uint256 i = 0; i < updates.length; i++) {
            ...
            caps[i] = Caps({
                supplyCap: updates[i].supplyCap,
                borrowCap: updates[i].borrowCap
            });
        }
